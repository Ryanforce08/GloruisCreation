...
if typing.TYPE_CHECKING:
    from robot import GloruisCreation
...
class PhysicsEngine:
    ...
    def __init__(self, physics_controller: PhysicsInterface, robot: "GloruisCreation"):
        """
